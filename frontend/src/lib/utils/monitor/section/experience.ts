/**
 * Experience section monitoring utility
 * Implements MonitorModule interface for experience section component visibility management
 */
...
import { DEFAULT_MANUAL_COMPONENTS, DEFAULT_SECTION_CONFIG, handleSectionCall, handleSectionExit, SHOW_ALL_ON_CALL_CONFIG, type SectionConfig } from './base';
...
/**
 * Creates the experience monitor module
 * @returns MonitorModule implementation for experience section
 */
export function createExperienceMonitor(): MonitorSectionModule {
    return {
        /**
        ...
        registeredComponents: (
            ...
            // Default config untuk experience section
        ...
        callSection: (): void => {
            ...
            // Handle registered components - show them when entering experience
            registeredComponents.forEach((visibility) => {
                visibility.show();
            });
        },
        ...
        monitorComponent: function(componentId: ComponentId): {
            ...
            // Determine if component should be visible based on experience section config
...
// Create and export the experience monitor instance
export const experienceMonitor = createExperienceMonitor();

/**
 * Returns all registered experience components.
 */
export function getRegisteredExperienceComponents(): Map<ComponentId, ReturnType<typeof createStateVisibility>> {
