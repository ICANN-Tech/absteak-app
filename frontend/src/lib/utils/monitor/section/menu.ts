/**
 * Menu section monitoring utility
 * Implements MonitorModule interface for menu section component visibility management
 */
...
/**
 * Creates the menu monitor module
 * @returns MonitorModule implementation for menu section
 */
export function createMenuMonitor(): MonitorSectionModule {
    return {
        /**
        ...
        registeredComponents: (
            ...
            // Default config untuk menu section
...
// Create the menu monitor instance
export const menuMonitor = createMenuMonitor();

// Export individual functions for convenience
export const showMenuComponents = menuMonitor.callSection;
export const hideMenuComponents = menuMonitor.exitSection;
export const registerMenuComponent = menuMonitor.registeredComponents;
export const unregisterMenuComponent = menuMonitor.unregisteredComponents;
export const getVisibleMenuComponents = menuMonitor.getVisibleComponents;
export const isMenuComponentVisible = menuMonitor.isComponentVisible;
export const monitorMenuComponent = menuMonitor.monitorComponent;

// Exclusive visibility functions
export const showOnlyMenuComponent = menuMonitor.showOnlyComponent;
export const hideOnlyMenuComponent = menuMonitor.hideOnlyComponent;
export const toggleMenuComponent = menuMonitor.toggleComponent;
export const showOnlyMenuComponents = menuMonitor.showOnlyComponents;
export const hideOnlyMenuComponents = menuMonitor.hideOnlyComponents;

// Tracking functions
export const getMenuComponentTrackingStore = menuMonitor.getComponentTrackingStore;
export const getRegisteredMenuComponentTrackingStore = menuMonitor.getRegisteredComponentTrackingStore;
export const isMenuComponentCurrentlyVisible = menuMonitor.isComponentCurrentlyVisible;
export const getAllMenuComponentsVisibilityStatus = menuMonitor.getAllComponentsVisibilityStatus;
export const getMenuComponentVisibilityStore = menuMonitor.getComponentVisibilityStore;
export const subscribeToMenuComponentVisibility = menuMonitor.subscribeToComponentVisibility;
export const subscribeToAllMenuComponentsVisibility = menuMonitor.subscribeToAllComponentsVisibility;
export const getMenuVisibilityStatistics = menuMonitor.getVisibilityStatistics;
export const updateMenuManualComponentsTracking = menuMonitor.updateManualComponentsTracking;

/**
 * Get registered menu components
 * @returns Map of registered menu components
 */
export function getRegisteredMenuComponents(): Map<ComponentId, ReturnType<typeof createStateVisibility>> {
