/**
 * Chef section monitoring utility
 * Implements MonitorModule interface for chef section component visibility management
 */
...
/**
 * Creates the chef monitor module
 * @returns MonitorModule implementation for chef section
 */
export function createChefMonitor(): MonitorSectionModule {
    return {
        /**
        ...
        registeredComponents: (
            ...
            // Default config untuk chef section
        ...
        /**
         * Shows all components when exiting chef section.
         */
        exitSection: (): void => {
            // Use reusable base function for manual components
         ...
         */
        monitorComponent: function(componentId: ComponentId): {
            shouldBeVisible: boolean;
            isInVisibleList: boolean;
        } {
            // Check if component is currently visible in the tracking store
            let isCurrentlyVisible = false;
            componentTrackingStore.subscribe(store => {
                isCurrentlyVisible = store.get(componentId) || false;
            })();
            
            // Determine if component should be visible based on chef section config
        ...
        toggleComponent: (targetComponentId: ComponentId): void => {
            ...
            if (currentState) {
                ...
                chefMonitor.showOnlyComponent(targetComponentId);
            }
        },
...
// Create the chef monitor instance
export const chefMonitor = createChefMonitor();

// Export individual functions for convenience
export const showChefComponents = chefMonitor.callSection;
export const hideChefComponents = chefMonitor.exitSection;
export const registerChefComponent = chefMonitor.registeredComponents;
export const unregisterChefComponent = chefMonitor.unregisteredComponents;
export const getVisibleChefComponents = chefMonitor.getVisibleComponents;
export const isChefComponentVisible = chefMonitor.isComponentVisible;
export const monitorChefComponent = chefMonitor.monitorComponent;

// Exclusive visibility functions
export const showOnlyChefComponent = chefMonitor.showOnlyComponent;
export const hideOnlyChefComponent = chefMonitor.hideOnlyComponent;
export const toggleChefComponent = chefMonitor.toggleComponent;
export const showOnlyChefComponents = chefMonitor.showOnlyComponents;
export const hideOnlyChefComponents = chefMonitor.hideOnlyComponents;

// Tracking functions
export const getChefComponentTrackingStore = chefMonitor.getComponentTrackingStore;
export const getRegisteredChefComponentTrackingStore = chefMonitor.getRegisteredComponentTrackingStore;
export const isChefComponentCurrentlyVisible = chefMonitor.isComponentCurrentlyVisible;
export const getAllChefComponentsVisibilityStatus = chefMonitor.getAllComponentsVisibilityStatus;
export const getChefComponentVisibilityStore = chefMonitor.getComponentVisibilityStore;
export const subscribeToChefComponentVisibility = chefMonitor.subscribeToComponentVisibility;
export const subscribeToAllChefComponentsVisibility = chefMonitor.subscribeToAllComponentsVisibility;
export const getChefVisibilityStatistics = chefMonitor.getVisibilityStatistics;
export const updateChefManualComponentsTracking = chefMonitor.updateManualComponentsTracking;

/**
 * Get registered chef components
 * @returns Map of registered chef components
 */
export function getRegisteredChefComponents(): Map<ComponentId, ReturnType<typeof createStateVisibility>> {
