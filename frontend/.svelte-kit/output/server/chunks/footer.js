...
import { h as handleSectionExit, b as handleSectionCall } from "./base3.js";
...
function createFooterMonitor() {
  return {
    ...
    callSection: () => {
      ...
      import("./visibility.js").then(({ setComponentVisibility, lockVisibility }) => {
        import("./index.js").then(({ ComponentId: ComponentId2 }) => {
          setComponentVisibility(ComponentId2.Highlight, false);
          lockVisibility(ComponentId2.Highlight, false);
        });
      });
      registeredComponents.forEach((visibility) => {
        visibility.hide();
    ...
    exitSection: () => {
      ...
      import("./visibility.js").then(({ resetComponentVisibility, unlockVisibility }) => {
        import("./index.js").then(({ ComponentId: ComponentId2 }) => {
          unlockVisibility(ComponentId2.Highlight);
...
const showFooterComponents = footerMonitor.callSection;
const hideFooterComponents = footerMonitor.exitSection;
const registerFooterComponent = footerMonitor.registeredComponents;
const unregisterFooterComponent = footerMonitor.unregisteredComponents;
const getVisibleFooterComponents = footerMonitor.getVisibleComponents;
const isFooterComponentVisible = footerMonitor.isComponentVisible;
const monitorFooterComponent = footerMonitor.monitorComponent;
const showOnlyFooterComponent = footerMonitor.showOnlyComponent;
const hideOnlyFooterComponent = footerMonitor.hideOnlyComponent;
const toggleFooterComponent = footerMonitor.toggleComponent;
const showOnlyFooterComponents = footerMonitor.showOnlyComponents;
const hideOnlyFooterComponents = footerMonitor.hideOnlyComponents;
const getFooterComponentTrackingStore = footerMonitor.getComponentTrackingStore;
const getRegisteredFooterComponentTrackingStore = footerMonitor.getRegisteredComponentTrackingStore;
const isFooterComponentCurrentlyVisible = footerMonitor.isComponentCurrentlyVisible;
const getAllFooterComponentsVisibilityStatus = footerMonitor.getAllComponentsVisibilityStatus;
const getFooterComponentVisibilityStore = footerMonitor.getComponentVisibilityStore;
const subscribeToFooterComponentVisibility = footerMonitor.subscribeToComponentVisibility;
const subscribeToAllFooterComponentsVisibility = footerMonitor.subscribeToAllComponentsVisibility;
const getFooterVisibilityStatistics = footerMonitor.getVisibilityStatistics;
const updateFooterManualComponentsTracking = footerMonitor.updateManualComponentsTracking;
function getRegisteredFooterComponents() {
