...
import { D as DEFAULT_MANUAL_COMPONENTS, a as DEFAULT_SECTION_CONFIG, b as handleSectionCall } from "./base3.js";
...
const showBookingComponents = bookingMonitor.callSection;
const hideBookingComponents = bookingMonitor.exitSection;
const registerBookingComponent = bookingMonitor.registeredComponents;
const unregisterBookingComponent = bookingMonitor.unregisteredComponents;
const getVisibleBookingComponents = bookingMonitor.getVisibleComponents;
const isBookingComponentVisible = bookingMonitor.isComponentVisible;
const monitorBookingComponent = bookingMonitor.monitorComponent;
const showOnlyBookingComponent = bookingMonitor.showOnlyComponent;
const hideOnlyBookingComponent = bookingMonitor.hideOnlyComponent;
const toggleBookingComponent = bookingMonitor.toggleComponent;
const showOnlyBookingComponents = bookingMonitor.showOnlyComponents;
const hideOnlyBookingComponents = bookingMonitor.hideOnlyComponents;
const getBookingComponentTrackingStore = bookingMonitor.getComponentTrackingStore;
const getRegisteredBookingComponentTrackingStore = bookingMonitor.getRegisteredComponentTrackingStore;
const isBookingComponentCurrentlyVisible = bookingMonitor.isComponentCurrentlyVisible;
const getAllBookingComponentsVisibilityStatus = bookingMonitor.getAllComponentsVisibilityStatus;
const getBookingComponentVisibilityStore = bookingMonitor.getComponentVisibilityStore;
const subscribeToBookingComponentVisibility = bookingMonitor.subscribeToComponentVisibility;
const subscribeToAllBookingComponentsVisibility = bookingMonitor.subscribeToAllComponentsVisibility;
const getBookingVisibilityStatistics = bookingMonitor.getVisibilityStatistics;
const updateBookingManualComponentsTracking = bookingMonitor.updateManualComponentsTracking;
function getRegisteredBookingComponents() {
