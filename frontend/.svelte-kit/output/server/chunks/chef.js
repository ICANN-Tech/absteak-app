...
const showChefComponents = chefMonitor.callSection;
const hideChefComponents = chefMonitor.exitSection;
const registerChefComponent = chefMonitor.registeredComponents;
const unregisterChefComponent = chefMonitor.unregisteredComponents;
const getVisibleChefComponents = chefMonitor.getVisibleComponents;
const isChefComponentVisible = chefMonitor.isComponentVisible;
const monitorChefComponent = chefMonitor.monitorComponent;
const showOnlyChefComponent = chefMonitor.showOnlyComponent;
const hideOnlyChefComponent = chefMonitor.hideOnlyComponent;
const toggleChefComponent = chefMonitor.toggleComponent;
const showOnlyChefComponents = chefMonitor.showOnlyComponents;
const hideOnlyChefComponents = chefMonitor.hideOnlyComponents;
const getChefComponentTrackingStore = chefMonitor.getComponentTrackingStore;
const getRegisteredChefComponentTrackingStore = chefMonitor.getRegisteredComponentTrackingStore;
const isChefComponentCurrentlyVisible = chefMonitor.isComponentCurrentlyVisible;
const getAllChefComponentsVisibilityStatus = chefMonitor.getAllComponentsVisibilityStatus;
const getChefComponentVisibilityStore = chefMonitor.getComponentVisibilityStore;
const subscribeToChefComponentVisibility = chefMonitor.subscribeToComponentVisibility;
const subscribeToAllChefComponentsVisibility = chefMonitor.subscribeToAllComponentsVisibility;
const getChefVisibilityStatistics = chefMonitor.getVisibilityStatistics;
const updateChefManualComponentsTracking = chefMonitor.updateManualComponentsTracking;
function getRegisteredChefComponents() {
